...
`app-ui` is the GPUI Kit adapter. It owns entities, windows, the application-level
...
- `scripts/test.ps1 -Suite gpui` enables Kit `test-support`, initializes the
  real Kit component globals, and tests the production Entity through typed
