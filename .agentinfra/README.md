...
Full and governance changes commit a ChangeSpec under `changes/`. Focused and
bot changes use a temporary ChangeSpec generated outside the repository.
Runner-generated evidence and remote trust controls are intentionally deferred.
The human lifecycle, rejection/review boundary, and local command order are in
